...
export default function ProfileCardPhone() {
  return (
    <div className="w-full max-w-sm mx-auto flex flex-col items-center h-full justify-between z-10">
      {/* Silo Background and Large Image */}
      <div className="relative w-[300px] flex flex-col items-center flex-shrink-0 h-full -mt-24" style={{ height: '400px' }}>
        {/* Background: fixed size and position */}
        <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[300px] h-[340px] bg-[#e9f1ff] dark:bg-[#5f6c89] rounded-t-full rounded-b-2xl z-0 shadow-md" />
        {/* Image: much larger, bottom aligned, pops out above background */}
        <div className="absolute left-1/2 -translate-x-1/2 bottom-0 flex items-end justify-center z-10 w-[380px] h-[380px]">
          <Image
      ...
      <div className="flex flex-col items-center w-[300px] flex-1 justify-between h-full py-2" style={{ minHeight: '60px', justifyContent: 'center', marginTop: '8px', marginBottom: '0' }}>
      ...
      {/* Resume Button */}
      <div className="flex justify-center w-[300px] mt-1 mb-0">
        <a
          href="/resume.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 text-xs py-1 rounded-lg w-[300px] bg-[#e9f1ff] dark:bg-[#5f6c89] text-[#2E2F35] shadow hover:bg-primary-100 transition-colors"
        >
