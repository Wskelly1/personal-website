...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-blue-50 py-12 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-2xl bg-transparent p-8 rounded-lg shadow-none space-y-8">
