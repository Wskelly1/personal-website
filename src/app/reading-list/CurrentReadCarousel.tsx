...
export default function CurrentReadCarousel({ books, onBookClick }: CurrentReadCarouselProps) {
  ...
  return (
    <div className="min-h-[26rem] flex flex-col items-center justify-center">
      <div className="relative flex items-center">
        ...
        <div
          className="group relative w-60 aspect-[2/3] rounded-lg overflow-hidden cursor-pointer border-4 border-[#e9f1ff] dark:border-[#5f6c89]"
          onClick={() => onBookClick?.(current._id)}
        >
          {current.imageUrl && current.imageUrl.startsWith('/book-images/') ? (
